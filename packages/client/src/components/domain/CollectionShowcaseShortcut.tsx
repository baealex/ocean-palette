...
export const CollectionShowcaseShortcut = () => {
    ...
    return (
        <Link
            ...
            search={searchParams}
            className="ui-focus-ring inline-flex h-10 items-center gap-1.5 rounded-token-md bg-surface-muted px-2.5 text-sm font-medium text-ink-muted transition-colors hover:text-ink"
        >
